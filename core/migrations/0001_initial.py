    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AVAILABLE', 'Available'), ('RESERVED', 'Reserved'), ('MAINTENANCE', 'Maintenance')], default='AVAILABLE', max_length=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caravan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.caravan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PAID', 'Paid'), ('FAILED', 'Failed')], max_length=6)),
